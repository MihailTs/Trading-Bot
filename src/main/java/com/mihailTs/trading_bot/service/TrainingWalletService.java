...
import com.mihailTs.trading_bot.repository.TrainingWalletRepository;
...
@Service
public class TrainingWalletService {

    private final TrainingWalletRepository walletRepository;

    public TrainingWalletService(TrainingWalletRepository walletRepository) {
