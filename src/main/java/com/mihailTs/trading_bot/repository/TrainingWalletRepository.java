...
@Repository
public class TrainingWalletRepository {

    private DatabaseConfig databaseConfig;

    public TrainingWalletRepository(DatabaseConfig databaseConfig) {
        this.databaseConfig = databaseConfig;
    }

    public List<Wallet> findAll() {
        ArrayList<Wallet> wallets = new ArrayList<>();
        String sql = "SELECT * FROM \"training-wallet\"";
    ...
    public Wallet findByCurrency(String currency) {
        String sql = "SELECT * FROM \"training-wallet\" WHERE currency= ? ";
    ...
    public void insert(Wallet wallet) throws SQLException {
        String sql = "INSERT INTO \"training-wallet\" (currency, total, created_at, updated_at) VALUES (?, ?, ?, ?)";
    ...
    public void updateWallet(Wallet wallet, BigDecimal amount) {
        String sql = "UPDATE \"training-wallet\" SET total = ?, updated_at = ? WHERE currency = ?";
